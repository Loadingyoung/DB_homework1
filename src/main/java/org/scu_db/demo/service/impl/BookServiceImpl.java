...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public Integer countBooksByCallnumber(String callnumber) {
        return bookRepository.countBooksByCallnumber(callnumber);
    }

    @Override
    public List<String> findBooksAtMostN(Integer n) {
        return bookRepository.findBooksAtMostN(n);
    }
}
